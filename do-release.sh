...
#./build-single.sh l4t resolute $1 &
...
#cloudsmith push deb moonlight-game-streaming/moonlight-l4t/ubuntu/resolute out_l4t-resolute/moonlight-qt_*.deb
...
cloudsmith push deb moonlight-game-streaming/moonlight-qt/ubuntu/resolute out_riscv64-resolute/moonlight-qt_*.deb
...
cloudsmith push deb moonlight-game-streaming/moonlight-qt/ubuntu/resolute out_armhf-resolute/moonlight-qt_*.deb
...
cloudsmith push deb moonlight-game-streaming/moonlight-qt/ubuntu/resolute out_aarch64-resolute/moonlight-qt_*.deb
...
#cloudsmith push deb moonlight-game-streaming/moonlight-l4t/ubuntu/resolute out_l4t-resolute/moonlight-qt-dbgsym_*.ddeb
...
cloudsmith push deb moonlight-game-streaming/moonlight-qt/ubuntu/resolute out_riscv64-resolute/moonlight-qt-dbgsym_*.ddeb
...
cloudsmith push deb moonlight-game-streaming/moonlight-qt/ubuntu/resolute out_armhf-resolute/moonlight-qt-dbgsym_*.ddeb
...
cloudsmith push deb moonlight-game-streaming/moonlight-qt/ubuntu/resolute out_aarch64-resolute/moonlight-qt-dbgsym_*.ddeb
