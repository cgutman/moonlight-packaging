...
#./build-image.sh l4t resolute $TAG_UNIQUE_ID &
...
./build-image.sh riscv64 resolute $TAG_UNIQUE_ID &
...
./build-image.sh armhf resolute $TAG_UNIQUE_ID &
wait
./build-image.sh aarch64 noble $TAG_UNIQUE_ID &
./build-image.sh aarch64 resolute $TAG_UNIQUE_ID &
...
#docker push cgutman/moonlight-packaging:l4t-resolute_$TAG_UNIQUE_ID
...
docker push cgutman/moonlight-packaging:armhf-resolute_$TAG_UNIQUE_ID
...
docker push cgutman/moonlight-packaging:aarch64-resolute_$TAG_UNIQUE_ID
docker push cgutman/moonlight-packaging:riscv64-trixie_$TAG_UNIQUE_ID
docker push cgutman/moonlight-packaging:riscv64-resolute_$TAG_UNIQUE_ID
